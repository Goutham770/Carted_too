  ...
  return (
    <div className="grid grid-cols-1 lg:px-16 sm:grid-cols-2 text-center font-poppins   lg:grid-cols-4 gap-6 p-6">
      {products.map((product) => (
        <div
          key={product.id}
          className="shadow-inner shadow-gray-300 p-4 hover:shadow-lg  hover:scale-105 transition flex flex-col items-center justify-center rounded-lg hover:border-purple-300"
        >
          <img
            src={product.image}
            alt={product.title}
          ...
          <Link
            ...
            className="border-2 font-bold bg-green-300 border-green-600 rounded-lg text-white hover:bg-transparent p-2 mt-2 block w-full text-center hover:bg-white scale-90 hover:text-green-500"
          >
            View Product
          </Link>
          ...
          {isInCart(product.id) ? (
            ...
            <button
              ...
              className="border-2 font-bold bg-green-300 border-green-600 rounded-lg text-white hover:bg-transparent p-2 mt-2 block w-full text-center hover:text-green-500 scale-90"
            >
              Add to Cart
            </button>
          )}
